...
@Autonomous(name = "🟥Red🟥 Far Intake", group = "Test", preselectTeleOp = BLUE_TELEOP_NAME)
public class Auto_RedFar_Intake extends OpMode {
    private Robot robot;
    ...
    public void init() {
        ...
        tm.print("🟥Red🟥 Far Intake Refactor Auto initialized");
        tm.update();
    }
