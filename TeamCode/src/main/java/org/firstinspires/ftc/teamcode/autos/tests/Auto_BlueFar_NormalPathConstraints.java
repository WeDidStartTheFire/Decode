...
public final class Auto_BlueFar_NormalPathConstraints extends BaseAuto<Auto_BlueFar_NormalPathConstraints.State> {
    ...
    private final Pose startPose = new Pose(63, 9.5, toRadians(90));
    private final Pose shootPose = new Pose(60, 18, toRadians(90));
