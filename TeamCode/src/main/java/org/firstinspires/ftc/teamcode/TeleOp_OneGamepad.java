...
//@TeleOp(name = "One Gamepad", group = "Into The Deep")
@Disabled
public class TeleOp_OneGamepad extends Base {
    ...
    boolean wasForwardWristServoButtonPressed = false;
    boolean wasBackwardWristServoButtonPressed = false;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            if (wristServo != null) {
                if (gamepad1.dpad_right && !wasForwardWristServoButtonPressed) {
                    if (wristServoGoal == 0.5) {
                        wristServoGoal = 1;
                    } else if (wristServoGoal == 0) {
                        wristServoGoal = 0.5;
                    }
                    wristServo.setPosition(wristServoGoal);
                }
                if (gamepad1.dpad_left && !wasBackwardWristServoButtonPressed) {
                    if (wristServoGoal == 0.5) {
                        wristServoGoal = 0;
                    } else if (wristServoGoal == 1) {
                        wristServoGoal = 0.5;
                    }
                    wristServo.setPosition(wristServoGoal);
                }
                wasForwardWristServoButtonPressed = gamepad1.dpad_right;
                wasBackwardWristServoButtonPressed = gamepad1.dpad_left;
