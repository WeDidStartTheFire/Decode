...
@Autonomous(name = "🟦Blue🟦 Close Intake", group = "!!!Primary", preselectTeleOp = BLUE_TELEOP_NAME)
public class Auto_BlueClose_Intake extends OpMode {
    private Robot robot;
    ...
    private final Pose intakeStart = new Pose(41.581, 84.630, toRadians(180));
    ...
    public void init() {
        ...
        tm.print("🟦Blue🟦 Close Intake Auto initialized");
