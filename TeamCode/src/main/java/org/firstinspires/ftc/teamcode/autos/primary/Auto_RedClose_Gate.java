...
@Autonomous(name = Auto_RedClose_Gate.name, group = "A", preselectTeleOp = RED_TELEOP_NAME)
public final class Auto_RedClose_Gate extends BaseAuto<Auto_RedClose_Gate.State> {
    ...
    static final String name = "🟥Red🟥 Close Gate";
    ...
    private final Pose shootPose = new Pose(84.5, 86, toRadians(0));
    private final Pose intakeStart1 = new Pose(92, 63, toRadians(0));
    private final Pose intakeEnd1 = new Pose(130, 63, toRadians(0));
    private final Pose intakeStart2 = new Pose(92, 85, toRadians(0));
    private final Pose intakeEnd2 = new Pose(125, 85, toRadians(0));
    private final Pose endPose = new Pose(109, 72, toRadians(0));
