...
@Autonomous(name = Auto_RedClose_9.name, group = "Test", preselectTeleOp = RED_TELEOP_NAME)
public final class Auto_RedClose_9 extends BaseAuto<Auto_RedClose_9.State> {
    ...
    static final String name = "🟥Red🟥 Close 9";
